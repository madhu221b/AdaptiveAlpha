...
def get_fair_transition_matrices(adj, node_attr, psi):
    ...
    for index, node_group in enumerate(node_attr):
        ...
        for ngh_group, degree_group in zip(neighborhood_groups, counts):
            ...
            if ngh_group == 0:
                P[index, nghs_of_that_group] = psi/degree_group
            elif ngh_group == 1:
                P[index, nghs_of_that_group] = one_minus_psi/degree_group
        ...
        for non_ngh_group in non_neighborhood_groups:
            ...
            if non_ngh_group == 0:
                P[index, n_nghs_of_that_group] = psi*group2frac[int(non_ngh_group)]
            elif non_ngh_group == 1:
                P[index, n_nghs_of_that_group] = (1-psi)*group2frac[int(non_ngh_group)]
...
def fair_personalized_page_rank(
    ...
    **kwargs,
    ...
    """
    batch_size = 10
    adj = get_fair_adjacency_matrix(adj=adj, node_attr=node_attr, psi=psi)
    return torch.cat(
        [
