...
class AdaptiveAlphaFixed(Walker):
    def __init__(self, graph, beta=0, alpha=0,workers=1, dimensions=64, walk_len=10, num_walks=200):
        print("ALPHA: {} - Test Fixed Alpha Non Local In Degree Walker with constant beta: {} And Local Random Walker ".format(alpha,beta))
        ...
        self._precompute_probabilities(alpha)
    ...
    def _precompute_probabilities(self, alpha):
